...
def main(args):
    ...
    runner.run()               #This line is the actual training. Everything before this was just setup. 
                               #Going all the way through this training workflow starting at this run() function will take you to r_mappo.py where the ppo learning happenes along with a lot of the equations in the DGPO paper
