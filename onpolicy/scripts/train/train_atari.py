...
#     parser.add_argument('--game_name', type=str, default='PongNoFrameskip-v4', help="Which Atari game to run on")
#     parser.add_argument('--num_agents', type=int, default=1, help="number of players")
#     # REMOVED: parser.add_argument('--n_rollout_threads', type=int, default=8, help="number of parallel environments")
...
# #     num_agents = all_args.num_agents  # Changed from get_map_params
...
# # if __name__ == "__main__":
# #     import sys
# #     sys.argv = ['train_atari.py', '--env_name', 'Atari', '--game_name', 'ALE/Pong-v5', '--max_z', '2', '--n_rollout_threads', '8']
# #     main(sys.argv[1:])
...
#         '--num_mini_batch', '2',        
#         '--vmapd_warmup', '2',
#         '--num_env_steps', '10000'      # about 50 episodes
#     ]
#     main(sys.argv[1:])
...
if __name__ == "__main__":
    ...
    sys.argv = [
        ...
        '--experiment_name', 'pong_v2', # NEW EXPERIMENT NAME
