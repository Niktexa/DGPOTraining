...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        self.policy = Policy(self.all_args,
                            ...
                            z_local_obs_space = self.envs.z_local_obs_space[0])
    ...
    def train(self):
        ...
        print(f"  Neural network updates...")
        train_infos = self.trainer.train(self.buffer)  # Calls the actual DGPO algorithm 
    ...
    def save(self):
        ...
        torch.save(policy_critic.state_dict(), str(self.save_dir) + "/ex_critic.pt")
    ...
    def restore(self):
        ...
        if not self.all_args.use_render:
            policy_critic_state_dict = torch.load(str(self.model_dir) + '/in_critic.pt')
            self.policy.in_critic.load_state_dict(policy_critic_state_dict)
